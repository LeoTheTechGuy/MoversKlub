...
export default function Footer() {
  return (
    <footer className="bg-white text-black dark:bg-black dark:text-white py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-black/60 dark:text-white/50 text-sm leading-relaxed mb-6">
            ...
            <div className="flex gap-4">
              ...
              <a 
                ...
                className="size-10 rounded-full bg-black/10 dark:bg-white/10 flex items-center justify-center text-black dark:text-white hover:opacity-90 transition-all duration-300"
              >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-black/60 dark:text-white/60">
              <li>
                <Link className="hover:text-black dark:hover:text-white transition-colors" href="#">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-black/60 dark:text-white/60">
              <li>
                <Link className="hover:text-black dark:hover:text-white transition-colors" href="/about">
                  About Us
                </Link>
              </li>
              <li>
                <Link className="hover:text-black dark:hover:text-white transition-colors" href="/careers">
                  Careers
                </Link>
              </li>
              <li>
          ...
          <div>
            <h4 className="font-bold mb-4 text-black dark:text-white">Contact</h4>
            <ul className="space-y-3 text-sm text-black/60 dark:text-white/60">
        ...
        <div className="pt-8 border-t border-black/10 dark:border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-black/60 dark:text-white/40 text-sm">
            ...
            <div className="flex gap-6 text-sm text-black/60 dark:text-white/40">
            <Link className="hover:text-black dark:hover:text-white transition-colors" href="#">
              Privacy
            </Link>
            <Link className="hover:text-black dark:hover:text-white transition-colors" href="#">
