    ...
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex justify-center">
          <button className="bg-primary hover:bg-primary-90 text-white text-lg font-bold px-10 py-4 rounded-xl shadow-xl shadow-primary/20 hover:shadow-2xl hover:-translate-y-1 transition-all cursor-pointer">
            Get Started Now
          </button>
        </div>
      </div>
